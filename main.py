...
if __name__ == "__main__":
    PDU_01 = I_PDU(ID = 0x23, SDU = data.encode('utf-8'), is_FD = True)
    PDU_02 = I_PDU(ID = 0x23, SDU = "Hello".encode('utf-8'), is_FD = True)
    PDU_03 = I_PDU(ID = 0x32, SDU = data.encode('utf-8'), is_FD = False)
    PDU_04 = I_PDU(ID = 0x32, SDU = "Laptop".encode('utf-8'), is_FD = False)
